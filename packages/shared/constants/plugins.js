...
export const PLUGIN_CATALOG = [
    {
        ...
        longDescription: 'This first-party plugin unlocks the Focus Forest page, store, backpack, and progression views without executing arbitrary plugin JavaScript.',
        features: [
